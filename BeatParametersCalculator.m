...
function  [BeatKinematicParameters, indBeatInStimStart,indBeatInStimEnd] = BeatParametersCalculator_13(n,tailMM, halfBeatExtrapolatedStructure, velocityBeatPropagationStructure, indRealBoutStart, interpSmootherTailCurveMeasure,boutCurvature,fps)                                                                                                  
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%test function%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%   n = 2;
%open variable
BeatKinematicParameters = zeros(1,50);
