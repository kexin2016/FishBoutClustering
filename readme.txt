...
(the whole set of feature including 2 and 3 is indicated in getEnumeratorBoutKinematicParams_more.m)
4.tsne and watershed, reassignment, etc.
5.evaluation
6.bout map and application to new data
