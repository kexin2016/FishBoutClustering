...
[rho,delta,maxjump,~] = calculateRhoAndDeltaMaxDensityJumpLinkage_5(data,nsamps,densityType,kdedens,linedensityMethod,numextra,doplot);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 makeplot4 = 0;
 [kdedensRand,~] = calculateLocalDensitiesScallingBWCORRECT(dataRand,kdedensRand,scallingFactor,densityType,makeplot4);

 
 
doplot = 0;
[rhoRand,deltaRand,~,~] = calculateRhoAndDeltaMaxDensityJumpLinkage_5(dataRand,nsamps,densityType,kdedensRand,linedensityMethod,numextra,doplot);
% size(dataRand)
...
[funnymeasureRandSorted, ~] = sort(funnymeasureRand, 'descend');
...
%sort funny measure
[funnymeasureSorted, ~] = sort(funnymeasure, 'descend');
