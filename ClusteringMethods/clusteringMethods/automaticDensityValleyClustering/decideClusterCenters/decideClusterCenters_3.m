...
function [indChoosenClusterCenters] = decideClusterCenters_3(data,tree,clusterCentersSortedIdx,realRho,funnymeasure)
...
subplot(2,2,4)
[~,~,perm] = dendrogram(tree,length(clusterCentersSortedIdx));
axis square
...
text(realRho(indChoosenClusterCenters(n)),funnymeasure(indChoosenClusterCenters(n))+0.02,num2str(indChoosenClusterCenters(n)))
% pause
