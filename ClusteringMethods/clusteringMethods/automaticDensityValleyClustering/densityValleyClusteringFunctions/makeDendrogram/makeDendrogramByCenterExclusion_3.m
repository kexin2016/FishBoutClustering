...
%%
     function [tree,clusterAssignmentAll,perm] = makeDendrogramByCenterExclusion_3(data,funnymeasure,maxNumbOfClusterCenters,rho,realRho,maxjump,pointAssignmentMethod,lowDensityCutOff,clusterCentersSortedIdx,makePlot)
