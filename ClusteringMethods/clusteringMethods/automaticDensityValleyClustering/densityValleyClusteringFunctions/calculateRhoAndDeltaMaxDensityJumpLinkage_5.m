...
%6) calcualtes max jump using linkage
...
%do single link cllustering (distance mthod euclidean) in norm densoty line map
t = linkage(squareform(densityNorm));

%determine the cophenetic distances between datapoints in tree
