...
%%
%%% calcualte rho delta and SImeasure for resampled distribution %%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% diffSImeasure2(1) = 1;
jumpFunymeasure = diff(diffSImeasure2);
