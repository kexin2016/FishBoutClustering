% function [indClusterCenters,clusterCore,clusterHalo,idx,distanceSquare,rho,delta,gama,dc] = densityPeaksClusteringSquare_3(data,percent,percOrdc,distAlreadyCalc,makePlot)
%%
%%%%%%%%%%%% test function %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
indClusterCenters = [];
while isempty(indClusterCenters)
