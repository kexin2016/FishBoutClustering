 function [indClusterCenters,clusterCore,clusterHalo,idx,distanceSquare,rho,delta,gama,dc] = densityPeaksClusteringSquare_4(data,percent,percOrdc,distAlreadyCalc,makePlot)
%%
%%%%%%%%%%%% test function %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
[~ ,maxInd] = max(rho.*delta);

indClusterCenters = [];
conrnerWasPicked = [];

 while isempty(indClusterCenters) ||  isempty(conrnerWasPicked)
% while   isempty(conrnerWasPicked)
rect = getrect;   
...
conrnerWasPicked = find(indClusterCenters == maxInd );
