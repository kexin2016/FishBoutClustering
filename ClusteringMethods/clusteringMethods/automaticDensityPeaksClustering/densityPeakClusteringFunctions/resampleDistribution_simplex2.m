function [resampledDist] = resampleDistribution_simplex2(origDist,nPoints,dataRho,doPlot)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 simplexvolume = simplexvolume/maxvolume;%make volume dependent of suze if simplex
...
%     %stop inversevey linearly with size of simplex
...
%%
%%%%%%%%%%%% stop loop if is according to rho distribution %%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    
randInd = randsample(length(dataRho),1);


dataVolTnis = dataVolumes(randInd);

if (dataVolTnis < simplexvolume)
