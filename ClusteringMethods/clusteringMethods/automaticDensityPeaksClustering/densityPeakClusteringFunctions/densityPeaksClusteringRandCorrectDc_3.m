function [indClusterCenters,clusterCore,clusterHalo,diffDiviation,diffDiviationReg,diffDiviationNorm,difference,deviationNorm,idx,distanceSquare,rho,delta,gama,dc] = densityPeaksClusteringRandCorrectDc_3(data,percent,percOrdc,multirep,distAlreadyCalc,numbPointsToShow,makePlot)
%%
%%%%%%%%%%%% test function %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if numbPointsToShow > length(deviationNorm)
    numbPointsToShow2 = length(deviationNorm);
else
    numbPointsToShow2 = numbPointsToShow;
end
    
plot(deviationNorm(1:numbPointsToShow2), 'o','MarkerSize',5,'MarkerFaceColor','k','MarkerEdgeColor','k');
...
if numbPointsToShow > length(diffDiviation)
    numbPointsToShow3 = length(diffDiviation);
else
    numbPointsToShow3 = numbPointsToShow;
end


plot(diffDiviation(1:numbPointsToShow3), 'o','MarkerSize',5,'MarkerFaceColor','c','MarkerEdgeColor','c');
