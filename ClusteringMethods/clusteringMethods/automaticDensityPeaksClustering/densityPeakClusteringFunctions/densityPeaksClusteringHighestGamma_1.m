function [indClusterCenters,clusterCore,clusterHalo,idx,distanceSquare,rho,delta,gama,dc] = densityPeaksClusteringHighestGamma_1(data,percent,percOrdc,distAlreadyCalc,numClusters,makePlot)
%%
%%%%%%%%%%%% test function %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
indClusterCenters = idx(1:numClusters);
