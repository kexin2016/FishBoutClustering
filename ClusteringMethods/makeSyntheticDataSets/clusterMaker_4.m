function [data,groundTruth] = clusterMaker_3(clusterDensityAvr,densityBetweenClusters,numberOfClusters,minNumberOfPointsPerCluster,totalNumberOfPoints,rad,points,makeEqualNumber,makeGaussian, MakePlot2)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if makeEqualNumber == 1

    
    numberPointsAll = zeros(1,numberOfClusters);
    numberPointsAll(:) = round(totalNumberOfPoints/numberOfClusters);
