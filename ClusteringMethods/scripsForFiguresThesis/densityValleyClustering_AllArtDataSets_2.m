...
% % figure
% % plot(data())
folder = 'C:\Joao analysis\BehaviorDataAnalysis_161111\ClusteringMethods\finalDataSetsToAnalyse\';

filename = 'dataSetStructure_1.mat';
...
save('dataSetStructureDensityValley_fastOnion.mat','dataSetStructure','-v7.3')