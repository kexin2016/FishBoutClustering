...
%%
 ...
 function [stim,lag,tailAngles,tailValues,bodyAngles,xPos,yPos,blobVal,pixelSize,headToBladderLength,tailSegmentLength,distanceEyesToBlob,dataSetNumbr,arenaX,arenaY,protocolNumb,leftEyeAngle,rightEyeAngle,numbFishInSquare,parameciaCounter,frameNumber] = DataBaseDetector_22(a,dataSetName)
...
%%
        ...
        if TF == 1
            ...
            protocolNumb = EnumeratorProtocol.DarkLightTransions4_6065;%projector off
