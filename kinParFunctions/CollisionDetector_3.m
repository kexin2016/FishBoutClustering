...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   ...
   if indNoCollisionStartAll(1) ~= 1 &&  collision(1) ~= 1.1%if there is no collision in first frame
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   ...
   if indNoCollisionEndAll(end) ~= length(aThisFish)  &&  collision(end) ~= 1.1%if there is no collision in last frame
