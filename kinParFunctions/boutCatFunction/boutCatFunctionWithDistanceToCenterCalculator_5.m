function [BoutInf,boutDataPCASample] = boutCatFunctionWithDistanceToCenterCalculator_5(BoutInf,BoutKinematicParameters,meanAllVar,stdAllVar,COEFF,maxKinPars,indKinPars,meanPCASpace,numbOfK,...
