...
function [BoutKinematicParameters] = BoutParametersCalculator_45(BeatKinematicParametersThisBout,indRealBoutEnd,indRealBoutStart,...
    ...
    C1MaxAngularSpeedLessSmooth,C2MaxAngularSpeedLessSmooth,interpBodyAnglesLessSmooth2)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
boutDuration = (indRealBoutEnd - indRealBoutStart)/7;%in ms it uses start and end of bout of beat detector

distBoutDuration = (indDistanceBoutEnd - indRealBoutStart)/7;% in ms
...
boutAngularSpeed2 = diff(normBoutBodyAngles)/0.14;%in degrees/ms
...
BoutKinematicParameters(EnumeratorBoutKinPar.beat1beatMaxAngularSpeedLessSmooth) = beatMaxAngularSpeedLessSmooth(1);
...
BoutKinematicParameters(EnumeratorBoutKinPar.beat2beatMaxAngularSpeedLessSmooth) = beatMaxAngularSpeedLessSmooth(2);
...
BoutKinematicParameters(EnumeratorBoutKinPar.beat2beatMaxAngularSpeedLessSmooth) = NaN;
...
BoutKinematicParameters(EnumeratorBoutKinPar.beat3beatMaxAngularSpeedLessSmooth) = beatMaxAngularSpeedLessSmooth(3);
...
BoutKinematicParameters(EnumeratorBoutKinPar.beat3beatMaxAngularSpeedLessSmooth) = NaN; 
...
%%
%%%%%%%%%%%%%%%% max angular speed with less smoothing %%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%


%normalize body angle
normBoutBodyAnglesLessSmooth = interpBodyAnglesLessSmooth2(1) - interpBodyAnglesLessSmooth2;
if mean(normBoutBodyAnglesLessSmooth) < 0
    
    normBoutBodyAnglesLessSmooth = normBoutBodyAnglesLessSmooth*-1*180/pi;
    
    
else
    normBoutBodyAnglesLessSmooth = normBoutBodyAnglesLessSmooth*180/pi;
    
end

boutAngularSpeedLessSmooth = diff(normBoutBodyAnglesLessSmooth)/0.14;%in degrees/ms

boutMaxAngularSpeedLessSmooth = max(abs(boutAngularSpeedLessSmooth));%degrees
boutAvrAngularSpeedLessSmooth = nanmean(abs(boutAngularSpeedLessSmooth));


BoutKinematicParameters(236) = boutMaxAngularSpeedLessSmooth;
BoutKinematicParameters(237) = boutAvrAngularSpeedLessSmooth;
BoutKinematicParameters(238) = C1MaxAngularSpeedLessSmooth;
BoutKinematicParameters(239) = C2MaxAngularSpeedLessSmooth;
