...
function [BoutInfThisBout] = boutInfMaker_17(zzzz,xPos,yPos,dataSetNumber,protocolNumber,fishUniqueNumber,thisBoutStim, boutPreviousStim,pixelSize,headToBladderLength,tailSegmentLength,distanceEyesToBlob,lastMeasuredSegment,fishAge,boutUniqueNumber,lagVector,allboutstarts,allboutends,sequenceOfBoutsInStim,uniqueFileNumber,sequenceOfBoutsInNoCollision,latencyOfBoutAfterStim,stimUniqueNumberBoutVector,brokenBouts,halfBeatPosWithNaNTag,halfBeatMagWithNaNTag,doubleBout,firstSegmentWithNotfixedMistakes,firstSegmentWithAnyMistake,realFishUniqueNumber,trueUniqueFishNumber,wellLetter)
...
BoutInfThisBout(156) = nan;%distance to center bout
