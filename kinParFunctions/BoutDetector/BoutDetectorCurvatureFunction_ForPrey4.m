...
%curvature data for each stim block
 ...
 function [allboutstarts,allboutends,indRealEnds] = BoutDetectorCurvatureFunction_Mike4(smootherTailCurveMeasure,indThisStimTypeStart,indThisStimTypeEnd,filteredDistance)
...
threshold=prctile(smootherTailCurveMeasure,80)
if (threshold > 0.4)
    threshold=0.4;
end
