...
%%
%%%%%%%%%%%%%%%% calculate ROC compare bout type with all others %%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%bout type
   ...
   if  percNaNs(n,nn) < 0.05%exclude kin pars that have many mistakes
...
%   indStructure(h).indsSorted = indsSorted;
  ...
  ROCKinMatrixSorted = ROCKinMatrix(:,inds);
...
indKinParsBest = [EnumeratorBoutKinPar.boutAmplitude6Max EnumeratorBoutKinPar.beat1beatAmplitude5 EnumeratorBoutKinPar.beat1beatAmplitude5...
    EnumeratorBoutKinPar.maxBoutFreqCorr...
...
%   indStructure(h).indsSorted = indsSorted;
  ...
  ROCKinMatrixSorted2 = ROCKinMatrix(:,inds);
