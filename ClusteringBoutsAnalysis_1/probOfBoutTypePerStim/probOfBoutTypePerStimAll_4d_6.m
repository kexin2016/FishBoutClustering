...
PathName = 'C:\JoaoStuff\boutTypeStuff\FreeData\boutTypeProject\boutClustering\allDataAssignment\';
...
[indStimSctructure,stimNameAll] = makeIndStimSctructure_4(BoutInf,BoutKinematicParameters);
...
indPrey = 175:189;
indSocial = [190 191];
indPreyStateAll = 192:211;
indPreyStateSpont = 192:196;
indPreyStateStart = 197:201;
indPreyStateConv = 202:206;
indPreyStateEnd = 207:211;
...
probBoutTypeWithSpaceGood = [probBoutTypeGoodSorted(ind3minLux,:)', probBoutTypeGoodSorted(ind3minLight,:)',spaceVector', probBoutTypeGoodSorted(   indSocial,:)',...
spaceVector',probBoutTypeGoodSorted(  indOMRSpeed5,:)', spaceVector',probBoutTypeGoodSorted(  indOMRTurns2,:)',spaceVector',probBoutTypeGoodSorted(   indPhototaxis,:)',...
 ...
 spaceVector',probBoutTypeGoodSorted(   indLoomingSpeed,:)'  , spaceVector', probBoutTypeGoodSorted(indPreyStateSpont,:)',spaceVector',...
 probBoutTypeGoodSorted(indPreyStateStart,:)',spaceVector',probBoutTypeGoodSorted(indPreyStateConv,:)'...
 ,spaceVector',probBoutTypeGoodSorted(indPreyStateEnd,:)']';
...
probBoutTypeWithSpaceGood1 = [probBoutTypeGoodSorted(ind3minLux,:)', probBoutTypeGoodSorted(ind3minLight,:)',spaceVector', probBoutTypeGoodSorted(   indSocial,:)',...
spaceVector',probBoutTypeGoodSorted(  indOMRSpeed5,:)', spaceVector',probBoutTypeGoodSorted(  indOMRTurns2,:)',spaceVector',probBoutTypeGoodSorted(   indPhototaxis,:)'...
spaceVector',probBoutTypeGoodSorted(   indLoomDirectionsColapsed,:)',...
spaceVector',probBoutTypeGoodSorted(   indLoomingSpeed,:)',spaceVector']';
...
probBoutTypeWithSpaceGood2 = [probBoutTypeGoodSorted(  indBeeps,:)', spaceVector',probBoutTypeGoodSorted(  indFlashBeeps,:)' , spaceVector',probBoutTypeGoodSorted(   indDarkFlashs,:)',...
 spaceVector', probBoutTypeGoodSorted(indPreyStateSpont,:)',spaceVector',...
 probBoutTypeGoodSorted(indPreyStateStart,:)',spaceVector',probBoutTypeGoodSorted(indPreyStateConv,:)'...
 ,spaceVector',probBoutTypeGoodSorted(indPreyStateEnd,:)']';



%spaceVector',spaceVector',spaceVector',spaceVector',spaceVector',spaceVector',spaceVector',spaceVector',spaceVector',spaceVector' ]';
