...
function [indStimSctructure,stimNameAll] = makeIndStimSctructure_2(BoutInf,BoutKinematicParameters)
...
ind1 = intersect(indGoodBouts,find(dataSetNumber == EnumeratorDataSet.PreyCaptureSmallRotTuNaive));
ind2 = intersect(indGoodBouts,find(dataSetNumber == EnumeratorDataSet.PreyCaptureSmallRotTuNaive2));


indStructureDataset(4).ind = [ind1' ind2' ]';



ind3 = intersect(indGoodBouts,find(dataSetNumber == EnumeratorDataSet.PreyCaptureNaiveTu));
ind4 = intersect(indGoodBouts,find(dataSetNumber == EnumeratorDataSet.PreyCaptureExpTu));

indStructureDataset(5).ind = [ind3' ind4' ]';
