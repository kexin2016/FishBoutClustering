...
probBoutTypeGood = probBoutTypeGood(:,idx);
...
spaceVector',probBoutTypeGood(   indLoomDirectionsColapsed,:)',...
spaceVector',probBoutTypeGood(   indLoomingSpeed,:)',spaceVector',spaceVector',spaceVector',spaceVector',spaceVector',spaceVector',spaceVector',spaceVector',spaceVector',spaceVector' ]';
