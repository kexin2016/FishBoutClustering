function [indStructure] = indStructureCreator_AllDataGoodStims(BoutInf,indGoodBouts,boutDataPCASample,makeplot)
...
%%
%%%%%%%%%%%%%% get inds of PreyCapture data set %%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

uniqueFishNumberPreyCapture = unique(trueUniqueFishNumber(indPreyCapture));

% uniqueFishNumberPreyCaptureAll = [uniqueFishNumberPreyCapture' uniqueFishNumberPreyCaptureNaive']';

for h = 1 : length(uniqueFishNumberPreyCapture)

    indThisFish = find(trueUniqueFishNumber == uniqueFishNumberPreyCapture(h));
    
    indThisFishEyeConv = intersect(indThisStim1, indThisFish);
    indThisFishNotEyeConv = intersect(indThisStim2, indThisFish);
 
    
    
indStructure(counter).thisInds = indThisFishEyeConv;
indStructure(counter).dataSet = 'SingleFishEyeConvPreyCapture';
indStructure(counter).stimNumb = 'NaN';


counter = counter +1;
% indStructure(counter).thisInds = indThisFishNotEyeConv;
% indStructure(counter).dataSet = 'SingleFishNotEyeConvPreyCapture';
% indStructure(counter).stimNumb = 'NaN';
% 
% counter = counter +1;
    
    %%
%     %%%%%%%%%%%%%%%%% look at fish in PCA space %%%%%%%%%%%%%%%%%%%%%%%%%%%
%     %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%     
% %     figure
% clf
%     subplot(1,2,1)
%     plot(boutDataPCASample(indThisFishEyeConv,1),boutDataPCASample(indThisFishEyeConv,2),'.k')
%     axis square
%     axis([-15 20 -10 15])
%     title(size(indThisFishEyeConv))
%     
%     subplot(1,2,2)
%     plot(boutDataPCASample(indThisFishNotEyeConv,1),boutDataPCASample(indThisFishNotEyeConv,2),'.k')
%     axis square
%     axis([-15 20 -10 15])
%     title(size(indThisFishNotEyeConv))
% 
% pause
...
%%
%%%%%%%%%%%%%% get inds of PreyCaptureNaive data set %%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
uniqueFishNumberPreyCaptureNaive = unique(trueUniqueFishNumber(indPreyCaptureNaive));


for h = 1 : length(uniqueFishNumberPreyCaptureNaive)

    indThisFish = find(trueUniqueFishNumber == uniqueFishNumberPreyCaptureNaive(h));
...
indStructure(counter).thisInds = indThisFishEyeConv;
indStructure(counter).dataSet = 'SingleFishEyeConvPreyCaptureNaive';
indStructure(counter).stimNumb = 'NaN';


counter = counter +1;
% indStructure(counter).thisInds = indThisFishNotEyeConv;
% indStructure(counter).dataSet = 'SingleFishNotEyeConvPreyCaptureNaive';
% indStructure(counter).stimNumb = 'NaN';
% 
% counter = counter +1;
