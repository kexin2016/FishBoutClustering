...
save('PCA_kNN4_39TailKins6dim.mat','boutDataPCASample','BoutInf','BoutKinematicParameters','indBoutsForPCA','behavioralSpaceStructure','indStructure','-v7.3')

%%
%%%%%%%%%%%%% save only behavioral space structure %%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
save('BehavioralSpace_FinalData_39TailKins6dim_1','behavioralSpaceStructure','-v7.3')
