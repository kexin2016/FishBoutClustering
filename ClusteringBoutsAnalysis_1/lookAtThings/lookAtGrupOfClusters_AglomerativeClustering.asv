...
cutThreshold = 16.5;
  ...
  Z1 = linkage(ROCareaNormDimProjtestNoNansGood,'average','seuclidean');
%    Z1 = linkage(ROCareaNormDimProjtest)

%  Z1 = linkage(ROCareaNormMax)

figure
imagesc(ROCareaNormDimProjtestNoNansGood)
axis square
colormap gray
...
ROCareaNormMaxPerm = ROCareaNormDimProjtestNoNansGood(perm1,perm1);
% subplot(2,3,5)
