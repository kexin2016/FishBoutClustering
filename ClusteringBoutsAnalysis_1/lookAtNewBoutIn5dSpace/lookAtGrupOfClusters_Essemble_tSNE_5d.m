...
%   cutThreshold = 16.6
 numbDist = 6;
[T2,Z2,essembleMatrixPerm,clusterStructure] = essemble_tSne_plot_3(essembleMatrix,boutDataPCASample,clusterStructure,groupClusterSctructureThis,cutThreshold,numbDist);
