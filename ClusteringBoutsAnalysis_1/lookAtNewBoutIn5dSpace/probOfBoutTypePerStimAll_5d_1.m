...
hold on
 plot3(boutDataPCASample(indThisClusterRandCore,1),boutDataPCASample(indThisClusterRandCore,2),boutDataPCASample(indThisClusterRandCore,5),'.','color',col(idx(nn),:))
hold on
axis square
...
% plot(boutDataPCASample(indThisClusterRandCore,1),boutDataPCASample(indThisClusterRandCore,2),'.','color',col(idx(nn),:))
% hold on
% axis square
% axis([-15 25 -10 15])   
% xlabel('PC 1')
...
probBoutTypeGoodSorted = probBoutTypeGood(:,[4 5 1 3 12 10 2 6 7 11 8 9]);
probBoutTypeSorted = probBoutTypeGood(:,[4 5 1 3 12 10 2 6 7 11 8 9]);

%%
%%%%%%%%%%%%%%% make heat map %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

spaceVector = (zeros(1, length(1:12)) + 1);
indOMRSpeed5 = 2:11;
indOMRTurns2 = 14:26;
indBeeps = 27:36;
indFlashBeeps = 37:46;
...
probBoutTypeWithSpaceGood = [probBoutTypeGoodSorted(ind3minLux,:)', probBoutTypeGoodSorted(ind3minLight,:)',...
spaceVector', probBoutTypeGoodSorted(indPrey,:)',...
spaceVector',probBoutTypeGoodSorted(  indOMRSpeed5,:)', spaceVector',probBoutTypeGoodSorted(  indOMRTurns2,:)',...
spaceVector',probBoutTypeGoodSorted(   indPhototaxis,:)',...
spaceVector',probBoutTypeGoodSorted(  indBeeps,:)', spaceVector',probBoutTypeGoodSorted(  indFlashBeeps,:)' ,...
spaceVector',probBoutTypeGoodSorted(   indDarkFlashs,:)',...
