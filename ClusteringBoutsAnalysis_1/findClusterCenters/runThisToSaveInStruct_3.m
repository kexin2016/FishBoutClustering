...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
folderTosave = 'C:\Joao analysis\FreeData\clusteringData\ClusterAssignment\final\';
fileName = 'ClusterAssignment_kNN4_74Kins4dims_1.75Smooth_slow_3000_auto_4roc_merged11.mat';

         save(strcat(folderTosave,fileName),'BoutKinematicParameters','BoutInf','boutDataPCASample','behavioralSpaceStructure','indStructure','-v7.3')
