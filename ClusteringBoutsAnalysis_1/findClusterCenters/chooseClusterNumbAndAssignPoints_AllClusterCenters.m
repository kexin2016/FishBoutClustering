...
%1) loads bahavioral dara after choosing cluster centers
...
[indChoosenClusterCenters] = decideClusterCentersAll_2(dataThisDataSetRand,tree,clusterCentersSortedIdx,realRho,funnymeasure,decisionMethod);
...
%                   pointAssignmentMethod = 'distance';
 ...
 makeplot = 0;
% tic
[clusterAssignmentDistance2] = assignDataPointsAllCases_1(dataThisDataSetRand,indChoosenClusterCenters,rho,maxjump,pointAssignmentMethod,makeplot);
% toc 
 ...
 makeplot = 0;
% tic
[clusterAssignmentDistance] = assignDataPointsAllCases_1(dataThisDataSetRand,indChoosenClusterCenters,rho,maxjump,pointAssignmentMethod,makeplot);
% toc 
 ...
 makeplot = 0;
% tic
[clusterAssignmentPooledDensity2] = assignDataPointsAllCases_1(dataThisDataSetRand,indChoosenClusterCenters,rho,maxjump,pointAssignmentMethod,makeplot);
% toc 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
uniqueCluster = unique(clusterAssignmentDistance2);

numbPointsAllClustersDistance2 = zeros(1,length(uniqueCluster));
percentagePointsAllClustersDistance2 = zeros(1,length(uniqueCluster));

numbPointsAllClustersDistance = zeros(1,length(uniqueCluster));
percentagePointsAllClustersDistance = zeros(1,length(uniqueCluster));

numbPointsAllClustersPooledDensity2 = zeros(1,length(uniqueCluster));
percentagePointsAllClustersPooledDensity2 = zeros(1,length(uniqueCluster));


for i = 1 : length(uniqueCluster)

    
    indThisCluster1 = find(clusterAssignmentDistance2 == uniqueCluster(i));
    
    indThisCluster2 = find(clusterAssignmentDistance == uniqueCluster(i));
    
    indThisCluster3 = find(clusterAssignmentPooledDensity2 == uniqueCluster(i));
    
    
    numbPointsAllClustersDistance2(i) = length(indThisCluster1);
    percentagePointsAllClustersDistance2(i) = length(indThisCluster1)./length(clusterAssignmentDistance2);
    
    numbPointsAllClustersDistance(i) = length(indThisCluster2);
    percentagePointsAllClustersDistance(i) = length(indThisCluster2)./length(clusterAssignmentDistance2);
    
    numbPointsAllClustersPooledDensity2(i) = length(indThisCluster3);
    percentagePointsAllClustersPooledDensity2(i) = length(indThisCluster3)./length(clusterAssignmentDistance2);
    
    
end
%  sort(  percentagePointsAllClusters )
...
indStructure(n).clusterAssignmentDistance2 = clusterAssignmentDistance2;
indStructure(n).clusterAssignmentDistance = clusterAssignmentDistance;
indStructure(n).clusterAssignmentPooledDensity2 = clusterAssignmentPooledDensity2;

indStructure(n).pointAssignmentMethod = 'all';

indStructure(n).numbPointsAllClustersDistance2 = numbPointsAllClustersDistance2;
indStructure(n).percentagePointsAllClustersDistance2 = percentagePointsAllClustersDistance2;

indStructure(n).numbPointsAllClustersDistance = numbPointsAllClustersDistance;
indStructure(n).percentagePointsAllClustersDistance = percentagePointsAllClustersDistance;

indStructure(n).numbPointsAllClustersPooledDensity2 = numbPointsAllClustersPooledDensity2;
indStructure(n).percentagePointsAllClustersPooledDensity2 = percentagePointsAllClustersPooledDensity2;
...
%  save('ClusterAssignmentAllData74Kins3dimWithCutOffMedium_1.mat','BoutKinematicParameters','BoutInf','boutDataPCASample','behavioralSpaceStructure','indStructure','-v7.3')
