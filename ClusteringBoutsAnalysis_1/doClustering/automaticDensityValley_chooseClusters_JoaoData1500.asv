...
% [indStructure] = indStructureCreator_MK801_AllData(BoutInf,indGoodBouts,boutDataPCASample,makeplot);
% [indStructure] = indStructureCreator_AllDataGoodStims(BoutInf,indGoodBouts,boutDataPCASample,makeplot)
[indStructure] = indStructureCreator_AllDataGoodStims_1500(BoutInf,indGoodBouts,boutDataPCASample,makeplot);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 save('ClusterAssignment_MK801_74Kins3dim_slow_3000_auto_NoControl.mat','BoutKinematicParameters','BoutInf','boutDataPCASample','behavioralSpaceStructure','indStructure','-v7.3')
