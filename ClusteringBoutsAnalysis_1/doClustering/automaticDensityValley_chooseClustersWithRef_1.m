...
%%%%%%%%%%%%%%%%%%%%pick ref %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load('E:\Joao\automaticBehaviorData\ReferenceDistribution\resampleDist_simplex_slow_1.75_100to5000.mat')
...
indResample = findnearest(resampleNumberAll,length(thisInds));

funnymeasureRandThreshold = referenceDistributionInf(indResample).funnymeasureRandThreshold;
...
save('ClusterAssignment_kNN4_74Kins3dims_1.75Smooth_slow_3000_auto_simplex.mat','BoutKinematicParameters','BoutInf','boutDataPCASample','behavioralSpaceStructure','indStructure','-v7.3')
