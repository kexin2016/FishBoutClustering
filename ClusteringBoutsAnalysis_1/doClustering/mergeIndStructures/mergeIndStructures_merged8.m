...
fileName = 'ClusterAssignment_kNN4_74Kins4dims_1.75Smooth_slow_3000_auto_4roc_merged7.mat';

path1 = strcat(folder,fileName);

%4d prey capture uncov bouts
folder = 'C:\Joao analysis\FreeData\preyCaptureData\ClusterAssignment\';
fileName = 'ClusterAssignment_PreyCaptureRita3_74Kins4dim_1.75Smooth_slow_3000_auto.mat';
...
save('C:\Joao analysis\FreeData\clusteringData\ClusterAssignment\final\ClusterAssignment_kNN4_74Kins4dims_1.75Smooth_slow_3000_auto_4roc_merged8.mat','BoutKinematicParameters','BoutInf','boutDataPCASample','behavioralSpaceStructure','indStructure','-v7.3')
