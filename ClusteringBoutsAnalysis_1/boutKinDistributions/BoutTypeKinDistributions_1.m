...
lowerBoundery =zeros(1,length(indKinPars));
higherBoundery = [130,230,20,13,50,14,130,300,250,30,20,360,40,17,360,200,80,50];
...
% higherBoundery = [6,6,3.5,3.5,5,3.5,5,6,6,3.5,3,6,4,3,6,5.5,4.5,4];
 ...
 indAngleKin = find(higherBoundery >= 6);
%%
...
%     indThisBoutTypeGood = intersect(indThisBoutType,indGoodBouts);
     indThisBoutTypeGood = intersect(indsBoutMapInAllData,intersect(indThisBoutType,indGoodBouts));
    ...
    if nn == indAngleKin(1) ||  nn == indAngleKin(2) ||  nn == indAngleKin(3) ||  nn == indAngleKin(4) ||  nn == indAngleKin(5) ||  nn == indAngleKin(6) ||  nn == indAngleKin(7) ||  nn == indAngleKin(8)
        ...
        indExclude = find(abs(thisKinParThisBouts) > 500);
