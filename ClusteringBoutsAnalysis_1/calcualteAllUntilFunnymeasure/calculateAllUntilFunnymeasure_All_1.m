...
%%
%%%%%%%%%%%%%%%%%%%%% create indStructure for all data%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%it creats indStructure for most of the data sets

[indStructure] = indStructureCreator_AllDataGoodStims(BoutInf,indGoodBouts);
...
save('funnymeasure_FinalData3_74Kins3dims_1.75Smooth_slow_3000_All.mat','BoutKinematicParameters','BoutInf','boutDataPCASample','behavioralSpaceStructure','indStructure','-v7.3')
