...
clusterAssignmentStruct(nn).clusterAssignmentAll = clusterAssignmentAll;
 ...
 save('clusterAssignmentStruct','clusterAssignmentStruct')
%%
%%%%%%%%%%%%%%%%%%%%%% calculate F score %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
numbInt = 100;
...
F1All = zeros(size(clusterAssignmentAllOrig,2), length(clusterAssignmentStruct) );


for j = 1 : size(clusterAssignmentAllOrig,2)%loop through each cluster solution
   ...
   indThisCluster = find(boutCatThisPart == uniqueBoutCat(jj));
