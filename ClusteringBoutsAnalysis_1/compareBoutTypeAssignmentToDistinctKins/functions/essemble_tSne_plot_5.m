 ...
 function [T2,Z2,essembleMatrixPerm,clusterStructure] = essemble_tSne_plot_5(essembleMatrix,boutDataPCASample,clusterStructure,groupClusterSctructureThis,cutThreshold,numbDist,makeplot,axisLim)
