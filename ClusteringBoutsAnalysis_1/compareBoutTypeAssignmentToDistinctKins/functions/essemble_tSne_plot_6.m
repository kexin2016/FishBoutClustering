 ...
 function [T2,Z2,essembleMatrixPerm,clusterStructure] = essemble_tSne_plot_6(essembleMatrix,boutDataPCASample,clusterStructure,groupClusterSctructureThis,cutThreshold,numbDist,makeplot,axisLim)
