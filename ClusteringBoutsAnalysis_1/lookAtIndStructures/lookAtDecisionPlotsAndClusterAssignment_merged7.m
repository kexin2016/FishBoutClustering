...
%     indDataSet =  [93 97 101];


%% rot data unconv - conv bouts
%      indDataSet =  [ 94    95    96    98    99   100   102   103   104];

 %% rot data naive Rita unconv - not conv
%      indDataSet =  [105];

 %% rot data naive Rita unconv - conv conv
%     indDataSet =  [106   107   108];

 %% rot data exp Rita unconv 
%     indDataSet =  [109];

 %% rot data exp Rita conv 
