...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 
% folder = 'C:\JoaoStuff\boutTypeStuff\FreeData\boutTypeProject\boutClustering\allDataAssignment\14Solution\';
% filename = 'BoutCat_kNN4_74Kins4dims_1.75Smooth_slow_3000_auto_4roc_withChasingDots.mat';
% 
% load(strcat(folder,filename), 'indStructure','boutDataPCASample')
% 
...
plot3(dataThisDataSetRand(indThisCluster,1),dataThisDataSetRand(indThisCluster,2),realRho(indThisCluster), '.', 'color', col(nn,:))
    ...
    ylabel('dim 1')
     axis([-17 22 -10 20 ]) 
         ...
         subplot(2,2,4)
scatter(dataThisDataSetRand(indThisCluster,1),dataThisDataSetRand(indThisCluster,2),5,realRho(indThisCluster),'filled')
