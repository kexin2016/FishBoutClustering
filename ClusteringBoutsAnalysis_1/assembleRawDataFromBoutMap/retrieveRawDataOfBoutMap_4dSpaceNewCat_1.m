...
%%%%%%%%%%%%%%% load bout map %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% load('C:\Joao analysis\FreeData\clusteringData\assignAllData\correct\BoutCat_AllDataWithLightTransitionsNoIndPrey_74Kins3dims_1.75Smooth_slow_100thres_tsne3_kNeighbor4_correct.mat')

%  load('C:\Joao analysis\FreeData\clusteringData\assignAllData\correct\BoutCat_AllDataWithLightTransitionsNoIndPrey_74Kins3dims_1.75Smooth_slow_100thres_tsne3_kNeighbor4.mat')
%   load('C:\Joao analysis\FreeData\clusteringData\final\BoutCat_kNN4_74Kins3dims_1.75Smooth_slow_3000_auto_final.mat');

load('C:\Joao analysis\FreeData\clusteringData\assignAllData\LDA\BoutCat_kNN4_74Kins4dims_1.75Smooth_slow_3000_auto_RotLDA1.mat')
%%
...
save('C:\Joao analysis\FreeData\clusteringData\boutMap\LDA\BoutMapWithRaw_kNN4_74Kins4dims_1.75Smooth_slow_3000_auto_RotLDA1.mat',...
