...
boutName = {'Approach swim','Slow 1','Slow 2','slow CS','Burst swim','J turn','HAT','Routine turn','SAR',...
    'O bend','LLE','C start', 'fast CS'};
 figure
...
filename = 'BoutMapWithRawCenters_kNN4_74Kins4dims_1.75Smooth_slow_3000_auto_4roc_merged10_corr.mat';
