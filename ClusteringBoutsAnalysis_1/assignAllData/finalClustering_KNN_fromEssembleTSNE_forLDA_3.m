...
FileName = 'BoutCat_kNN4_74Kins4dims_1.75Smooth_slow_3000_auto_4roc_merged7.mat';
...
mappedX = tsneDistributions(9).mappedX;
...
finalClustering.boutUniqueNumberInAllData = BoutInf(:,EnumeratorBoutInf.dataSetNumber);
...
% % 
% PathName = 'C:\Joao analysis\FreeData\clusteringData\assignAllData\LDA\';
% FileName = 'BoutMap_kNN4_74Kins4dims_1.75Smooth_slow_3000_auto_4roc_merged7.mat';
% 
% 
