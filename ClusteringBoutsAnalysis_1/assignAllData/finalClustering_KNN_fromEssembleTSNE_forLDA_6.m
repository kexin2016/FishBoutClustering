...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
finalClustering.idx = [ 11 7 9 1 2 3 5 13 8 12 4 10 6];
...
for i = 1 : length(indGroupCluster2)
    ...
    clusterAssignmentMap = [clusterAssignmentMap' (zeros(length(indCore),1) + i)' ]';         
          
          
%     subplot(1,2,1)
%     plot3(boutDataPCASample(indCore,1),boutDataPCASample(indCore,2),boutDataPCASample(indCore,3),'.','color', colThis(i,:))
%     hold on
%     %plot(boutDataPCASample(thisIndRandFinalAll(indCore),1),boutDataPCASample(thisIndRandFinalAll(indCore),2),'.','color', 'b')
% 
%     axis square
...
%           
%     subplot(1,2,2)
%     plot3(boutDataPCASample(indCore,1),boutDataPCASample(indCore,2),boutDataPCASample(indCore,4),'.','color', colThis(i,:))
%     hold on
%     axis square
%     axis([-20 25 -10 20 -10 10])
...
%%%%%%%%%%%%%%%%% make plot %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
uniqueBoutCat = unique(clusterAssignmentInAllData);

figure
for n = 1 : length(uniqueBoutCat)
    
    
    indThisCluster = find(clusterAssignmentMap == uniqueBoutCat(idx(n)));
    
    %     subplot(1,2,1)
    plot3(finalData(indThisCluster,1),finalData(indThisCluster,2),finalData(indThisCluster,3),'.','color', colThis(n,:))
    hold on
...
indThisCluster = find(clusterAssignmentInAllData == idx(k));
