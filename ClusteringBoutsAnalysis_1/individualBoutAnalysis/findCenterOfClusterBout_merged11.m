...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%boutCatFinalArray2 = finalClustering.clusterAssignmentInMap;
...
plot(boutDataPCASampleFinalArray(indClosestBoutToTheCenter(idx(n)),1),boutDataPCASampleFinalArray(indClosestBoutToTheCenter(idx(n)),2),'o','MarkerEdgeColor','k','MarkerFaceColor',col((n),:),'MarkerSize',5)
...
boutName = {'Approach swim','Slow 1','Slow 2','Slow CS', 'Fast CS','Slow CS','Fast CS','Burst swim','J turn','HAT','Routine turn','SAR',...
    'O bend','LLE','C start'};
 figure
for i = 1 : length(indClosestBoutToTheCenter)
% i =1
     cumsumInterpFixedSegmentAngles = FishDataMap(indBoutStartAllDataInFinalArray(indClosestBoutToTheCenter(idx(i))):indBoutEndAllDataInFinalArray(indClosestBoutToTheCenter(idx(i))),EnumeratorFishData.cumsumInterpFixedSegmentAngles)*180/pi;
     beat1beatAmplitude8 = BoutKinematicParametersFinalArray(indClosestBoutToTheCenter(idx(i)),EnumeratorBoutKinPar.beat1beatAmplitude8);
