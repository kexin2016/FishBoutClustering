...
PathName = 'C:\JoaoStuff\boutTypeStuff\FreeData\boutTypeProject\boutClustering\allDataAssignment\13Solution\';
...
%%%%%%%%%%%%%%%%%%%%% save data %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
PathName = 'C:\JoaoStuff\boutTypeStuff\FreeData\boutTypeProject\boutClustering\GroupOfClusters\13_Solution\';
FileName = 'GroupsClusters_kNN4_74Kins4dims_1.75Smooth_slow_3000_auto_4roc_merged11_updated3_linearCenters.mat';



save(strcat(PathName,FileName),'groupClusterSctructure','ROCareaNormDimProjtestNoNans','indStructure','behavioralSpaceStructure',...
   'clusterStructure','boutDataPCASample','BoutKinematicParameters','BoutInf','-v7.3')
