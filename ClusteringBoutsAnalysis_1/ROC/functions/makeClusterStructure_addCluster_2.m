function [clusterStructure] = makeClusterStructure_addCluster_2(indStructure,minNumbClusterPoints,percClusterThres,corePerc,indToAddAllClusters,indExcludeClusters,makeplot) 
