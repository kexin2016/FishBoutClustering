 ...
 function [groupClusterSctructureThis,essembleMatrix,essembleMatrixRand] = groupClusters_EssembleTSNE_function_3(ROCareaNormDimProjtestNoNans,numbOfTimes,numbDims,perplexity,densityType,scallingFactorGroupClusters,linedensityMethod)
