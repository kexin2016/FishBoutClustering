...
function [T2,Z2,essembleMatrixPerm,clusterStructure] = essemble_tSne_plot_forMergedData(essembleMatrix,clusterStructure,groupClusterSctructureThis,cutThreshold,numbDist,makeplot,axisLim)
...
%     axis square
    ...
    if makeplot == 1
    plot(boutDataPCASampleDataThisCluster(:,1),boutDataPCASampleDataThisCluster(:,2), '.', 'color', col(hh,:))
    hold on
    end
