 ...
 function [groupClusterSctructureThis,essembleMatrix,essembleMatrixRand] = groupClusters_EssembleTSNE_function_5...
     (ROCareaNormDimProjtestNoNans,numbOfTimes,numbDims,perplexity,densityType,scallingFactorGroupClusters,...
