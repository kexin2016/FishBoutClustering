 ...
 function [groupClusterSctructureThis,essembleMatrix,essembleMatrixRand] = groupClusters_EssembleTSNE_function_4_changeIteractions(ROCareaNormDimProjtestNoNans,numbOfTimes,numbDims,perplexity,densityType,scallingFactorGroupClusters,linedensityMethod,distanceTsne,max_iter)
...
mappedX = tsne_d_withPars(ROCareaNormDimProjtestNoNans, [], numbDims, perplexity,momentum,final_momentum,mom_switch_iter,stop_lying_iter,max_iter,epsilon,min_gain);
