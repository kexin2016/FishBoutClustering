 ...
 function [T2,Z2,essembleMatrixPerm,clusterStructure] = essemble_tSne_plot_2(essembleMatrix,boutDataPCASample,clusterStructure,groupClusterSctructureThis,cutThreshold)
