...
function [T2,Z2,essembleMatrixPerm,clusterStructure] = essemble_tSne_plot_forMergedData_3(essembleMatrix,clusterStructure,groupClusterSctructureThis,cutThreshold,numbDist,boutDataPCASample,makeplot,axisLim)
...
rectPos = [axisLim(1) (axisLim(4)-5) 5 5]; 
