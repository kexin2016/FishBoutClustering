function [clusterStructure] = makeClusterStructure_addCluster_3(indStructure,boutDataPCASample,minNumbClusterPoints,percClusterThres,corePerc,indToAddAllClusters,indExcludeClusters,makeplot) 
